  ...
  return (
    <div className="post-card">
     <div className="flex-between">
      ...
      <img src="/public/assets/icons/edit.svg" alt="edit" width={20} height={20} /></Link>
      </div> 
      <Link to={`/posts/${post.$id}`}>
        ...
        <img src={post.imageUrl || '/public/assets/icons/profile-placeholder.svg'} alt="post-image" 
        className="post_card-img"/>
      </Link>
