          ...
          <div className="post_details-info">
            <div className="flex-between w-full">
              <Link to={`/profile/${post?.creator.$id}`} className="flex items-center gap-3">
                <img src={post?.creator?.imageUrl || '/public/assets/icons/profile-placeholder.svg'} alt='creator' className="rounded-full w-8 h-8 lg:w-12 lg:h-12" />
              ...
              <div className="flex-center gap-4">
                ...
                <Button onClick={handleDeletePost} variant='ghost' className={`ghost_fetails-delete_btn ${user.id !== post?.creator.$id && 'hidden'}`}>
